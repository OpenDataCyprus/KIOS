...
void dijkstraDisvSecond(int source,  int numNodes, int num_of_edges, int n,double **matrix,int *prev,long double *d,  int* visited, double distance, int difLevel, int *dest, double **adjList ) {
